...
@register_task('scst_task')
class SCSTTask(FairseqTask):
    @staticmethod
    def add_args(parser):
        ...
        parser.add_argument('--cached-tokens', type=str, default='coco_train_idx',
    ...
    def setup_task(cls, args, **kwargs):
        ...
        return SCSTTask(args, captions_dict)
    ...
    def setup_sc(self, args):
        ...
        return generator, {'Cider': Cider_scorer, 'BLEU4': Bleu_scorer}, \
    ...
    def train_step(self, sample, model, criterion, optimizer, ignore_grad=False):
        ...
        if self.args.bleu_reward_weight > 0:
            res_bleu = {i: res[i] for i in range(len(res_cider))}
    ...
    def valid_step(self, sample, model, criterion):
        ...
        cider, cider_scores = self.valid_scorer.compute_score(gts_cider, res_cider)
